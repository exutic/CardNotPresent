...
public class PersonLinkActivity extends AppCompatActivity {


    RecyclerView recyclerView;
    Button btn_refresh, btn_CreatePdf;
    PersonLinkAdapter personLinkAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_person_link);

        findViews();

        online = isOnline(PersonLinkActivity.this);
        if (online) {
            coonection_True();
        } else {
            coonection_False();
        ...
        btn_CreatePdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (PERMISSION_VALIDATOR == 1) {
                    ...
                    Toast.makeText(PersonLinkActivity.this, "دسترسی به حافطه مسدود میباشد", Toast.LENGTH_SHORT).show();
                    Toast.makeText(PersonLinkActivity.this, getResources().getText(R.string.permission_validator_toast), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void create_Pdf() {
        ...
        if (resultPdfList != null && resultPdfList.size()>0)
        {
            ...
            Toast.makeText(PersonLinkActivity.this, "در حال ذخیره فایل، لطفا صبر کنید", Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                Toast.makeText(PersonLinkActivity.this, "ذخیره شد", Toast.LENGTH_LONG).show();
                document.close();
            } catch (IOException e) {
                Log.e("main", "error " + e.toString());
                Toast.makeText(PersonLinkActivity.this, "Something wrong: " + e.toString(), Toast.LENGTH_LONG).show();
            }
    ...
    private void findViews() {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(PersonLinkActivity.this));
        ...
        btn_Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edtName_s.length() > 0 || edtAmountStart.length() > 0 || edtAmountEnd.length() > 0 || edtNationalCode_s.length() > 0 || edtFamily_s.length() > 0
                    ...
                    Toast.makeText(PersonLinkActivity.this, "حداقل یک قسمت پر شود", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        String partDate = part1[0];
    ...
    private void recordNotFoundDialog() {
        ...
        goHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                PersonLinkActivity.super.onBackPressed();
            }
        });
    ...
    private void setOnClickSearch() {
        ...
        if (firstField == 1)
            personLinkAdapter.filterList(parentFilteredList);
...
//        stringNationalCode = convert_PersianNumber_To_Englishnumber(stringNationalCode);
            ...
            if (filteredListResult.size() == 0) {
                ...
                personLinkAdapter.filterList(filteredListResult);
                checkListBoolean = 1;
            }


        } else {
            Toast.makeText(PersonLinkActivity.this, "گزینه ای برای جستجو وجود ندارد", Toast.LENGTH_SHORT).show();
        }
            ...
            public void onResponse(@NotNull Call<Model_ResultStatus> call, @NotNull Response<Model_ResultStatus> response) {
                ...
                if (userData.getUsernameValidation().equals("true")) {
                    ...
                    if (modelArrayList != null) {
                        personLinkAdapter = new PersonLinkAdapter(modelArrayList, PersonLinkActivity.this);
                        recyclerView.setAdapter(personLinkAdapter);
                        parentFilteredList = modelArrayList;
                    } else {
                        Toast.makeText(PersonLinkActivity.this, "هیچ لینک فعالی برای اشخاص موجود نمیباشد", Toast.LENGTH_SHORT).show();
                    }
                    linearLayout.setVisibility(View.GONE);
                }
            }
