...
public class PerTransAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private List<PersonsTransModel> contactParentsList;
    private Context mContext;
    private List<PersonsTransModel> contactParentsListFull;

    private ArrayList<Integer> arrayList = new ArrayList<>();
    private Persons_Transaction_ListFragment persons_transaction_listFragment;

    PerTransAdapter(List<PersonsTransModel> contactParentsList, Context mContext, Persons_Transaction_ListFragment fragment) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        final PersonsTransModel personsTransModel = (PersonsTransModel) contactParentsList.get(position);

        onBindActions(viewHolder,personsTransModel,position);
    }

    public void filterList(List<PersonsTransModel> filteredList) {
...
//            txtPersonTranUserId.setVisibility(View.GONE);
    ...
    private void onBindActions(final ViewHolder viewHolder, final PersonsTransModel personsTransModelTest, final int position) {
